    ...
    function i() {
        ...
        !t ||
            ...
            ((n = document.createElement("ul")).innerHTML =
                '<a href="#" class="logo"><img src=`${PATH_ROOT}/assets/images/logo-sm.png` alt="" height="22"></a>'),
            Array.from(
                document
            ...
            0 < e.querySelectorAll(".notification-item").length
                ...
                : (e.querySelector(".view-all") &&
                  ...
                  e.querySelector(".empty-notification-elem") ||
                      (e.innerHTML +=
                          '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src=`${PATH_ROOT}/assets/images/svg/bell.svg` class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function W() {
        var e;
